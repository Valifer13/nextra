...
const Hero = () => {
  return (
    <section
      id="hero"
      className="sm:bg-none bg-no-repeat bg-cover bg-center bg-hero-pattern mx-auto max-w-7xl h-screen md:px-8 grid place-content-center px-5 before:content-[''] sm:before:hidden before:absolute before:top-0 before:left-0 before:w-full before:h-screen before:bg-black before:opacity-30 before:z-[1]"
    >
      <div className="container grid lg:grid-flow-col items-center relative z-[2] text-white w-full">
        ...
        <div className="container w-2/4 md:block hidden md:row-start-1 drop-shadow-2xl">
          <svg
            className="lg:w-[38rem] lg:h-[38rem] h-[48rem] w-[48rem]"
            viewBox="0 0 200 200"
            xmlns="http://www.w3.org/2000/svg"
          >
            <path
