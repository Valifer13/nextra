    ...
    <footer className="bg-white">
      <div className="mx-auto max-w-screen-xl px-4 pb-6 pt-16 sm:px-6 lg:px-8">
        <div className="lg:flex lg:items-center lg:justify-between">
          ...
          <p className="mt-4 max-w-md text-center leading-relaxed text-gray-500 sm:text-left lg:mt-0 text-2xl font-medium">
        ...
        <div className="mt-16 grid grid-cols-1 gap-8 border-t border-gray-100 pt-16 md:grid-cols-4 lg:grid-cols-5">
          ...
          <div className="text-center sm:text-left">
            <p className="text-lg font-medium text-gray-900">Advertise</p>
            ...
            <div className="mx-auto mt-8 max-w-md sm:ms-0">
              ...
              <form className="mt-4">
                <div className="flex flex-col gap-4 sm:flex-row lg:flex-col lg:items-start">
                  ...
                  <button
                    className="block rounded-full bg-black px-8 py-3 font-medium text-white transition hover:bg-gray-900"
                    type="submit"
                  >
                    Subscribe
                  </button>
